    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                JSONObject currentBook = earthquakeArray.getJSONObject(i);
                ...
                Book book = new Book(title, authorName, imageUrl, url);
